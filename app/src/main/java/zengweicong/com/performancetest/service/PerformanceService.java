...
import zengweicong.com.performancetest.utils.Constants;
...
public class PerformanceService extends Service {
	...
	private final static String LOG_TAG = "Performance-"
			+ PerformanceService.class.getSimpleName();
	...
	public void onCreate() {
		...
		des = new EncryptData("performance");
	...
	private void createResultCsv() {
		...
		resultFilePath = Settings.Performance_RESULT_DIR + mDateTime + "_" + packageName
				+ ".csv";
		try {
	...
	final Handler mHandler=new Handler()
	{
		public void handleMessage(Message msg)
		{
			switch(msg.what)
			{
				...
				case 1:
					Toast.makeText(PerformanceService.this,
							getString(R.string.send_fail_toast) + PerformanceService.resultFilePath,
							Toast.LENGTH_LONG).show();
					break;
				case 2:
	...
	public void onDestroy() {
		...
		if (!BLANK_STRING.equals(startTime)) {
			replaceFileString(resultFilePath, START_TIME,
					getString(R.string.start_time) + Constants.COMMA
							+ startTime + Constants.LINE_END);
		} else {
