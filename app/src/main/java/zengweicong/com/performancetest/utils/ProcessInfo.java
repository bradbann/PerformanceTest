...
public class ProcessInfo {
	 ...
	 */
	public List<zengweicong.com.performancetest.utils.Programe> getRunningProcess(Context context) {
		Log.i(LOG_TAG, "get running processes");
		List<zengweicong.com.performancetest.utils.Programe> progressList = new ArrayList<zengweicong.com.performancetest.utils.Programe>();
		...
		for (ApplicationInfo appinfo : getPackagesInfo(context)) {
			zengweicong.com.performancetest.utils.Programe programe = new Programe();
	 ...
	 */
	public List<zengweicong.com.performancetest.utils.Programe> getAllPackages(Context context) {
		...
		for (ApplicationInfo appinfo : getPackagesInfo(context)) {
			zengweicong.com.performancetest.utils.Programe programe = new Programe();
			//(app.activityInfo.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM) <= 0
//			if (((appinfo.processName != null) &&((appinfo.flags & ApplicationInfo.FLAG_SYSTEM)>0)&& (appinfo.processName
//							.equals(PACKAGE_NAME)))) {
//				continue;
//			}
			if (((appinfo.processName != null) && (appinfo.processName
					.equals(PACKAGE_NAME)))) {
				continue;
			}
			programe.setPackageName(appinfo.processName);
	 ...
	 * @return pid
	 */
	public zengweicong.com.performancetest.utils.Programe getProgrameByPackageName(Context context, String packageName) {
		if (Build.VERSION.SDK_INT < ANDROID_P) {
			List<zengweicong.com.performancetest.utils.Programe> processList = getRunningProcess(context);
			for (zengweicong.com.performancetest.utils.Programe programe : processList) {
