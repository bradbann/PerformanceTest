...
import zengweicong.com.performancetest.utils.WakeLockHelper;

/**
 * Setting Page of Performance
 *
 */
public class SettingsActivity extends Activity {

	private static final String LOG_TAG = "Performance-" + SettingsActivity.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		layGoBack.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				intent.putExtra("xxx","hhhh");
				setResult(RESULT_OK,intent);
				finish();
			}
		});
		testReport.setOnClickListener(startActivityListener(zengweicong.com.performancetest.activity.TestListActivity.class));
